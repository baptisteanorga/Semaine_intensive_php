...
drawArc(ctx, 200,300,60, 0, ratio_0*power_0, 4, '#00FFFF')
drawArc(ctx, 200,300,50, 0, ratio_0*combat_0, 4, 'blue')
...
drawArc(ctx, 200,300,60, 0, Math.PI, 1, '#00FFFF')
drawArc(ctx, 200,300,50, 0, Math.PI, 1, 'blue')
}
...
drawArc(ctx, 200,200,60, 0, -(ratio_1*power_1)  , 4, '#00FFFF','false')
drawArc(ctx, 200,200,50, 0, -(ratio_1*combat_1), 4, 'blue','false')
...
drawArc(ctx, 200,200,60, 0, Math.PI, 1, '#00FFFF','false')
drawArc(ctx, 200,200,50, 0, Math.PI, 1, 'blue','false')
}
drawPie2()