    ...
    <!-- <form class='search'>
        ...
        ?>
            ...
            <div class="heroes">
                ...
                <div>Intelligence: <?= $heroes_0->powerstats->intelligence?></div>
                <div>Strength: <?= $heroes_0->powerstats->strength?></div>
                <div>Speed: <?= $heroes_0->powerstats->speed?></div>
                <div>Durability: <?= $heroes_0->powerstats->durability?></div>
                <div>Power: <?= $heroes_0->powerstats->power?></div>
                <div>Combat: <?= $heroes_0->powerstats->combat?></div>
            ...
            <div class="heroes">
                ...
                <div>Full-name: <?= $heroes_1->biography->{'full-name'} ?></div>
                <div>Intelligence: <?= $heroes_1->powerstats->intelligence?></div>
                <div>Strength: <?= $heroes_1->powerstats->strength?></div>
                <div>Speed: <?= $heroes_0->powerstats->speed?></div>
                <div>Durability: <?= $heroes_0->powerstats->durability?></div>
                <div>Power: <?= $heroes_0->powerstats->power?></div>
                <div>Combat: <?= $heroes_0->powerstats->combat?></div>
            ...
            <div>
            <?php 
                if (($heroes_0->powerstats->intelligence) > ($heroes_1->powerstats->intelligence))
                {
                ...
                else if (($heroes_0->powerstats->intelligence)<($heroes_1->powerstats->intelligence))
                {
                    ...
                    $message_result= $clever.' est plus intelligent que '.$heroes_0->name;
                }
                else
                {
        ...
        ?>
        <div class="sticker  <?=$_heroes_class = preg_replace('/\s+/', '', $_heroes)?>" data-name ="<?=$_heroes?>" data-id="<?=$id?>">
            <div><?=$_heroes?></div>
            <img class="img_sticker" src= "<?= str_replace('http://', 'https://',$heroes_0->image->url )?>" alt="">
            <div><?=$id?></div>
            </div>
        <?php
            $id++; 
